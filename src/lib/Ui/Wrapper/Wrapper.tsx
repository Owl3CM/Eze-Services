  ...
  render() {
    ...
    return (
      <div id={this.id} {...props}>
        {reload && (
          <div className={this.reloaderProps.containerClassName} style={{ display: "none" }} id="reloader-container">
            {reloader}
          </div>
        )}
        {children}
...
export default ({
  ...
  const _props = { service, reload, loadMore, reloader, addStateBuilder, className, ...props };
