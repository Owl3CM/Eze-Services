...
export default class PaginatedContainerTest extends React.Component {
  constructor({
    service,
    onRefresh,
    useRefresh,
    ...
    this.refresh = useRefresh ? onRefresh || service.reload : null
  }
  componentDidMount() {
    ...
    if (this.refresh) {
      pullToRefreshEvent(this.container, service, this.refresh)
    }
  }
  render() {
    const {
